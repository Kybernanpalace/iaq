...
// Count total records
$count_stmt = $pdo->query("SELECT COUNT(*) as total FROM cadcandidato");
...
$stmt = $pdo->prepare("SELECT * FROM cadcandidato ORDER BY id DESC LIMIT ? OFFSET ?");
...
<td class="text-center">
    ...
    <div class="text-center">
        <small class="text-muted">
            Mostrando <?= count($candidates) ?> de <?= $total_records ?> registros
